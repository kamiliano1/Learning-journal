    ...
    return (
        <div className="container">
            <div className="about--me--head">
                <img  className="about--me--avatar" src="/images/about-me-avatar.png" alt="Roku is smiling" />
                <div>
                    <h1 className="title about__title">Hi there! My name is Roku and welcome to my learning journal.</h1>
